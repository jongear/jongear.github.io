...
Since EEG data is inherently messy I opted for a offline training approach for teaching our system intent. I won't go deep into [Machine Learning](https://en.wikipedia.org/wiki/Machine_learning)
...
[Supervised Learning](https://en.wikipedia.org/wiki/Supervised_learning) to teach out system to match EEG data to
