...
Before I started working on the "mind-control" portion of this project. I recognized early on that I will want to have some form of fail safe in case my
...
Ok perfect, so now we can takeoff, land and turn our drone right or left. But what if we want to go forward and backwards as well as pilot our craft in
