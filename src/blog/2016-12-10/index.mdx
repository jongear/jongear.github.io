...
![SpikenzieLabs Usessless Machine Box](./useless-machine-box.jpg)
...
![Usless Machine Parts](./useless-machine-parts.jpg)
<p style="text-align: center;">
_The kit comes with acrylic body plates, a servo, battery compartment, assembled circuit board and screws_
</p>

[![Link to youtube video of machine functionality](./useless-machine-vid.png)](https://www.youtube.com/watch?v=H8xLUsYtLJo)
...
![Finished Machine](./finished-machine.jpg)
<p style="text-align: center;">
_Lid does not lay flush with the rest of the kit_
</p>

![Machine in action](./machine-in-action.jpg)
